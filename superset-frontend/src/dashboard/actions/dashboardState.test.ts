...
describe('dashboardState actions', () => {
  ...
  describe('saveDashboardRequest', () => {
    ...
    test('should not clear certification fields when they are undefined in dashboard data', async () => {
      ...
      const dashboardDataWithoutCertification = {
        ...newDashboardData,
      };
      delete dashboardDataWithoutCertification.certified_by;
      delete dashboardDataWithoutCertification.certification_details;

      const thunk = saveDashboardRequest(
        dashboardDataWithoutCertification,
        1,
        SAVE_TYPE_OVERWRITE,
      );
      thunk(dispatch, getState);
    ...
    test('should preserve certification fields when they are explicitly set', async () => {
      const { getState, dispatch } = setup();

      const certifiedDashboardData = {
        ...newDashboardData,
